...
<body>
 ...
 color: #fff; font-weight: bold; background-color: #A9A9A9; padding: 8px 12px; border-radius: 4px;">Retour</a>
    <form action="conexion.php" method="post">
        ...
        <br>
        <br>
        <p><a href="http://127.0.0.1/eliquide-menu/pages/espace-membre/motdepasseoublie.php">Mot de passe oublié ?</a>
        </p>


        <p><b>pas de compte ? <a
                    href="http://127.0.0.1/eliquide-menu/pages/espace-membre/inscription.php">inscription</a></b>
        </p>
    </form>
